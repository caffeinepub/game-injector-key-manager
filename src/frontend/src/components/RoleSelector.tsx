      ...
      <div className="max-w-md w-full mx-4 relative z-10">
        <div className="bg-black/40 backdrop-blur-xl border-2 border-red-500/40 shadow-2xl shadow-red-500/30 p-8 space-y-6 rounded-lg">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-200/80">Select your role to continue</p>
          </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            >
              ...
              <div className="relative flex flex-col items-center justify-center gap-2 h-full">
                ...
                <div className="text-center">
                  <div className="font-semibold text-lg text-gray-100 group-hover:text-red-300 transition-colors duration-300">
                    Admin
                  </div>
            ...
            >
              ...
              <div className="relative flex flex-col items-center justify-center gap-2 h-full">
                ...
                <div className="text-center">
                  <div className="font-semibold text-lg text-gray-100 group-hover:text-rose-300 transition-colors duration-300">
                    Reseller
                  </div>
                  <div className="text-xs text-gray-300/70">
