...
import type { KeyId as _KeyId, LoginKey as _LoginKey, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createKey(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createKey(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getKeyById(arg0: KeyId): Promise<LoginKey> {
        if (this.processError) {
            try {
                ...
                return from_candid_LoginKey_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_LoginKey_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _LoginKey): LoginKey {
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        expires: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.expires)),
        blocked: value.blocked,
        used: value.used
    };
}
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_LoginKey>): Array<LoginKey> {
    return value.map((x)=>from_candid_LoginKey_n2(_uploadFile, _downloadFile, x));
}
